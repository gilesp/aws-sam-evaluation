...
This is a sample template for transcribe - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name transcribe --tail
```
...
```bash
aws cloudformation delete-stack --stack-name transcribe
```
